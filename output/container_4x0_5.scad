module Container_num_x_4_num_y_0_5(){
  difference(){
    translate([106.4, 12.425, 0])color("red")difference(){
          translate([-106.9, -12.925, 0])color("purple")union()linear_extrude(height=45)translate([2.5, 2.5, 0])hull(){
                      circle(d=5,$fn=64);
                      translate([208.8, 0, 0])circle(d=5,$fn=64);
                      translate([0, 20.85, 0])circle(d=5,$fn=64);
                      translate([208.8, 20.85, 0])circle(d=5,$fn=64);
                    }

          translate([-105.4, -11.425, 2.296])union()linear_extrude(height=45.008)translate([1, 1, 0])hull(){
                    circle(d=2,$fn=64);
                    translate([208.8, 0, 0])circle(d=2,$fn=64);
                    translate([0, 20.85, 0])circle(d=2,$fn=64);
                    translate([208.8, 20.85, 0])circle(d=2,$fn=64);
                  }
