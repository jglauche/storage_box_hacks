module Container_num_x_3_0_num_y_0_5(){
  difference(){
    translate([79.55000000000001, 12.425, 0])color("red")difference(){
          translate([-80.05000000000001, -12.925, 0])color("purple")union()linear_extrude(height=45)translate([2.5, 2.5, 0])hull(){
                      circle(d=5,$fn=64);
                      translate([155.1, 0, 0])circle(d=5,$fn=64);
                      translate([0, 20.85, 0])circle(d=5,$fn=64);
                      translate([155.1, 20.85, 0])circle(d=5,$fn=64);
                    }

          translate([-78.55, -11.425, 2.296])union()linear_extrude(height=45.008)translate([1, 1, 0])hull(){
                    circle(d=2,$fn=64);
                    translate([155.1, 0, 0])circle(d=2,$fn=64);
                    translate([0, 20.85, 0])circle(d=2,$fn=64);
                    translate([155.1, 20.85, 0])circle(d=2,$fn=64);
                  }
