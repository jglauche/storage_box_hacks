module Container_num_x_2_num_y_0_5(){
  difference(){
    translate([52.7, 12.425, 0])color("red")difference(){
          translate([-53.2, -12.925, 0])color("purple")union()linear_extrude(height=45)translate([2.5, 2.5, 0])hull(){
                      circle(d=5,$fn=64);
                      translate([101.4, 0, 0])circle(d=5,$fn=64);
                      translate([0, 20.85, 0])circle(d=5,$fn=64);
                      translate([101.4, 20.85, 0])circle(d=5,$fn=64);
                    }

          translate([-51.7, -11.425, 2.296])union()linear_extrude(height=45.008)translate([1, 1, 0])hull(){
                    circle(d=2,$fn=64);
                    translate([101.4, 0, 0])circle(d=2,$fn=64);
                    translate([0, 20.85, 0])circle(d=2,$fn=64);
                    translate([101.4, 20.85, 0])circle(d=2,$fn=64);
                  }
