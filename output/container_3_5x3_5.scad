module Container_num_x_3_5_num_y_3_5(){
  difference(){
    translate([92.975, 92.975, 0])color("red")difference(){
          translate([-93.475, -93.475, 0])color("purple")union()linear_extrude(height=45)translate([2.5, 2.5, 0])hull(){
                      circle(d=5,$fn=64);
                      translate([181.95, 0, 0])circle(d=5,$fn=64);
                      translate([0, 181.95, 0])circle(d=5,$fn=64);
                      translate([181.95, 181.95, 0])circle(d=5,$fn=64);
                    }

          translate([-91.975, -91.975, 2.296])union()linear_extrude(height=45.008)translate([1, 1, 0])hull(){
                    circle(d=2,$fn=64);
                    translate([181.95, 0, 0])circle(d=2,$fn=64);
                    translate([0, 181.95, 0])circle(d=2,$fn=64);
                    translate([181.95, 181.95, 0])circle(d=2,$fn=64);
                  }

        }

    union(){
      translate([185.45, 0, 0])union(){
          translate([-185.45, 185.45, 0])union(){
              translate([185.45, 0, 0])union(){
                  translate([-185.45, -185.45, 0])union(){
