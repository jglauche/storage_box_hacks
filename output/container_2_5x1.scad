module Container_num_x_2_5_num_y_1(){
  difference(){
    translate([66.125, 25.85, 0])color("red")difference(){
          translate([-66.625, -26.35, 0])color("purple")union()linear_extrude(height=45)translate([2.5, 2.5, 0])hull(){
                      circle(d=5,$fn=64);
                      translate([128.25, 0, 0])circle(d=5,$fn=64);
                      translate([0, 47.7, 0])circle(d=5,$fn=64);
                      translate([128.25, 47.7, 0])circle(d=5,$fn=64);
                    }

          translate([-65.125, -24.85, 2.296])union()linear_extrude(height=45.008)translate([1, 1, 0])hull(){
                    circle(d=2,$fn=64);
                    translate([128.25, 0, 0])circle(d=2,$fn=64);
                    translate([0, 47.7, 0])circle(d=2,$fn=64);
                    translate([128.25, 47.7, 0])circle(d=2,$fn=64);
                  }
