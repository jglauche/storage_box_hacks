module Container_num_x_3_0_num_y_3_0(){
  difference(){
    translate([79.55, 79.55, 0])color("red")difference(){
          translate([-80.05, -80.05, 0])color("purple")union()linear_extrude(height=45)translate([2.5, 2.5, 0])hull(){
                      circle(d=5,$fn=64);
                      translate([155.1, 0, 0])circle(d=5,$fn=64);
                      translate([0, 155.1, 0])circle(d=5,$fn=64);
                      translate([155.1, 155.1, 0])circle(d=5,$fn=64);
                    }

          translate([-78.55, -78.55, 2.296])union()linear_extrude(height=45.008)translate([1, 1, 0])hull(){
                    circle(d=2,$fn=64);
                    translate([155.1, 0, 0])circle(d=2,$fn=64);
                    translate([0, 155.1, 0])circle(d=2,$fn=64);
                    translate([155.1, 155.1, 0])circle(d=2,$fn=64);
                  }
