module Container_num_x_4_num_y_2_5(){
  difference(){
    translate([106.4, 66.125, 0])color("red")difference(){
          translate([-106.9, -66.625, 0])color("purple")union()linear_extrude(height=45)translate([2.5, 2.5, 0])hull(){
                      circle(d=5,$fn=64);
                      translate([208.8, 0, 0])circle(d=5,$fn=64);
                      translate([0, 128.25, 0])circle(d=5,$fn=64);
                      translate([208.8, 128.25, 0])circle(d=5,$fn=64);
                    }

          translate([-105.4, -65.125, 2.296])union()linear_extrude(height=45.008)translate([1, 1, 0])hull(){
                    circle(d=2,$fn=64);
                    translate([208.8, 0, 0])circle(d=2,$fn=64);
                    translate([0, 128.25, 0])circle(d=2,$fn=64);
                    translate([208.8, 128.25, 0])circle(d=2,$fn=64);
                  }
