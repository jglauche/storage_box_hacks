module Container_num_x_4_num_y_1_5(){
  difference(){
    translate([106.4, 39.275, 0])color("red")difference(){
          translate([-106.9, -39.775, 0])color("purple")union()linear_extrude(height=45)translate([2.5, 2.5, 0])hull(){
                      circle(d=5,$fn=64);
                      translate([208.8, 0, 0])circle(d=5,$fn=64);
                      translate([0, 74.55, 0])circle(d=5,$fn=64);
                      translate([208.8, 74.55, 0])circle(d=5,$fn=64);
                    }

          translate([-105.4, -38.275, 2.296])union()linear_extrude(height=45.008)translate([1, 1, 0])hull(){
                    circle(d=2,$fn=64);
                    translate([208.8, 0, 0])circle(d=2,$fn=64);
                    translate([0, 74.55, 0])circle(d=2,$fn=64);
                    translate([208.8, 74.55, 0])circle(d=2,$fn=64);
                  }
