module Container_num_x_1_5_num_y_1_5(){
  difference(){
    translate([39.27500000000001, 39.27500000000001, 0])color("red")difference(){
          ...
          translate([-38.275, -38.275, 1.996])union()linear_extrude(height=45.008)translate([2.5, 2.5, 0])hull(){
                    circle(d=5,$fn=64);
                    translate([71.55, 0, 0])circle(d=5,$fn=64);
                    translate([0, 71.55, 0])circle(d=5,$fn=64);
                    translate([71.55, 71.55, 0])circle(d=5,$fn=64);
                  }
    ...
    union(){
      ...
      translate([-1.25, 76.8, 41.5])color("Teal")cube([2.5, 2.5, 3.6]);
      translate([76.8, -1.25, 41.5])color("Teal")cube([2.5, 2.5, 3.6]);
      translate([76.8, 76.8, 41.5])color("Teal")cube([2.5, 2.5, 3.6]);
    }
