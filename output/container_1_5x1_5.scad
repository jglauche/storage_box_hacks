module Container_num_x_1_5_num_y_1_5(){
  difference(){
    translate([39.275, 39.275, 0])color("red")difference(){
          translate([-39.775, -39.775, 0])color("purple")union()linear_extrude(height=45)translate([2.5, 2.5, 0])hull(){
                      circle(d=5,$fn=64);
