module Container_num_x_4_num_y_3(){
  difference(){
    translate([106.4, 79.55, 0])color("red")difference(){
          translate([-106.9, -80.05, 0])color("purple")union()linear_extrude(height=45)translate([2.5, 2.5, 0])hull(){
                      circle(d=5,$fn=64);
                      translate([208.8, 0, 0])circle(d=5,$fn=64);
                      translate([0, 155.1, 0])circle(d=5,$fn=64);
                      translate([208.8, 155.1, 0])circle(d=5,$fn=64);
                    }

          translate([-105.4, -78.55, 2.296])union()linear_extrude(height=45.008)translate([1, 1, 0])hull(){
                    circle(d=2,$fn=64);
                    translate([208.8, 0, 0])circle(d=2,$fn=64);
                    translate([0, 155.1, 0])circle(d=2,$fn=64);
                    translate([208.8, 155.1, 0])circle(d=2,$fn=64);
                  }
