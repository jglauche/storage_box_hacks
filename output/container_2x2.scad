module Container_num_x_2_num_y_2(){
  difference(){
    translate([52.7, 52.7, 0])color("red")difference(){
          translate([-53.2, -53.2, 0])color("purple")union()linear_extrude(height=45)translate([2.5, 2.5, 0])hull(){
                      circle(d=5,$fn=64);
                      translate([101.4, 0, 0])circle(d=5,$fn=64);
                      translate([0, 101.4, 0])circle(d=5,$fn=64);
                      translate([101.4, 101.4, 0])circle(d=5,$fn=64);
                    }

          translate([-51.7, -51.7, 2.296])union()linear_extrude(height=45.008)translate([1, 1, 0])hull(){
                    circle(d=2,$fn=64);
                    translate([101.4, 0, 0])circle(d=2,$fn=64);
                    translate([0, 101.4, 0])circle(d=2,$fn=64);
                    translate([101.4, 101.4, 0])circle(d=2,$fn=64);
                  }
